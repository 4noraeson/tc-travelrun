...
echo '<tr style="letter-spacing: 1px" height="35" bgcolor="#151515"><th style="border-top-left-radius: 5px"><font color="#FFFFFF"><b>Drug</b></font></th><th><font color="#FFFFFF"><b>Country</b></font></th><th><font color="#FFFFFF"><b>Updated?</b></font></th><th><font color="#FFFFFF"><b>Quantity</b></font></th><th style="border-top-right-radius: 5px"><font color="#FFFFFF"><b>Price</b></font></th></tr>';
$olddrug = '';
$oddgroup = 0;
foreach ($drugs as $d) {
  ...
  echo '<tr bgcolor="#A4A4A4" height="25">';
