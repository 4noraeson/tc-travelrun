...
echo '<br>';
echo 'or look at the most recent <a href="flowers.php">flower</a> or <a href="drugs.php">drug</a> information or <a href="http://travelrun.torncentral.com/itemall.php">most recent all items info</a> across all countries.';
echo '</div>';
